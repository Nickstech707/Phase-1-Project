...
function SubscribeForm({ newJobs = [] }) {
  ...
  return (
    <div className="w-full min-h-[200px] flex items-center justify-center bg-gradient-to-b from-emerald-900/20 to-transparent rounded-xl p-4 md:p-6">
      <div className="w-full max-w-md mx-auto">
        <div className="text-center mb-4 md:mb-6">
          <p className="text-sm md:text-base text-emerald-200/80 px-2">
            Get notified when new jobs are posted. No spam, no clutter.
          </p>
        </div>
